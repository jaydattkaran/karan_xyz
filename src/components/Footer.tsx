...
export const Footer = () => {
  ...
  return (
    <footer className="mt-14 flex items-end justify-between px-5 py-4 sm:flex text-[#ffffff] md:text-body-3">
    ...
    <button onClick={toTop} className="cursor-pointer col-span-2 flex items-center space-x-2 w-fit group 2xl:text-body-1">
